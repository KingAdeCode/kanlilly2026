...
const portfolioImages = [
  ...
  'https://res.cloudinary.com/dn786s1zr/image/upload/v1776364560/IMG_6531_cu26ce.jpg',
...
const services = [
  {
    ...
    description:
      'Expert artistry tailored for every occasion. From soft glam to high-fashion editorial, we craft bespoke looks that elevate your unique features.',
    items: [
      'BRIDAL MAKEUP',
  ...
  },
  {
    ...
    title: 'Hair Service',
    description:
      "Sculptural styling with precision and care. Whether it's a seamless wig installation or an elegant updo, we ensure your hair is a masterpiece.",
    items: [
      'WIG INSTALLATION',
  ...
  },
  {
    ...
    description:
      'Your dream day demands perfection. We offer comprehensive bridal support from the initial consultation down to the final glow on your wedding day.',
    items: [
...
<template>
  <div>
    ...
    >
      <div
        class="flex justify-between items-center px-6 md:px-12 py-6 max-w-screen-2xl mx-auto relative z-50"
      >
        <div>
          <img
            src="https://res.cloudinary.com/dn786s1zr/image/upload/v1776107418/kanlilly-white_l44zbc.svg"
            class="w-28"
          />
        </div>
        ...
        <div class="hidden md:flex items-center space-x-12">
          <a
            :class="[
              'font-notoSerif text-lg hover:scale-105 transition-all transition-transform duration-300',
              activeSection === 'home'
                ? 'text-[#ebbb4d] border-b border-[#ebbb4d]/30 pb-1'
                : 'text-white/70 hover:text-[#ebbb4d]',
            ]"
            href="#home"
            >Home</a
          >
        ...
        <div class="flex items-center gap-4">
          <a
            href="https://wa.me/2347085360145"
            target="_blank"
      ...
      >
        ...
        >
          <a
            ...
            :class="[
              'text-xl font-notoSerif transition-colors transition-transform duration-300',
              activeSection === 'home'
                ? 'text-[#ebbb4d]'
                : 'text-white/70 hover:text-[#ebbb4d]',
            ]"
          ...
          <a
            @click="isMobileMenuOpen = false"
            :class="[
              'text-xl font-notoSerif transition-colors transition-transform duration-300 pt-2 border-t border-white/5',
              activeSection === 'services'
                ? 'text-[#ebbb4d]'
                : 'text-white/70 hover:text-[#ebbb4d]',
            ]"
    ...
    >
      <div class="absolute inset-0 z-0">
        <img
          alt="High-end editorial makeup portrait"
      ...
      <div class="relative z-10 text-center px-6">
        <span
          class="font-label text-sm tracking-[0.5em] text-primary mb-6 block uppercase"
          >Welcome to</span
        >
        <h1
          class="text-7xl md:text-9xl font-headline text-on-background tracking-tighter mb-8"
        >
          KANLILLY
        </h1>
        <p
      ...
      >
        <span
          class="font-label text-[10px] tracking-widest text-outline uppercase"
          >Scroll to Explore</span
        >
        <div
          class="w-[1px] h-16 bg-gradient-to-b from-primary to-transparent"
        ></div>
      </div>
    </header>
    <!-- Services Overview -->
    <section id="services" class="py-12 md:py-32 px-6 md:px-12 bg-surface">
      <div class="max-w-screen-2xl mx-auto">
        <div
          class="flex flex-col md:flex-row justify-between items-start mb-24 gap-8"
        >
          <div class="max-w-2xl">
            <!--<span
              class="font-label text-xs tracking-[0.3em] text-primary uppercase mb-4 block"
              >Our Services</span
            > -->
            <h2
              class="text-3xl lg:text-4xl font-headline text-on-background leading-tight"
            >
              Our Services
            </h2>
          </div>
        ...
        <div
          class="grid grid-cols-1 lg:grid-cols-3 gap-px bg-outline-variant/20"
        >
          <div
          ...
          >
            <span
              class="font-headline italic text-4xl text-outline-variant mb-10 block"
              >{{ service.id }}</span
            >
            <h3
              class="text-2xl lg:text-3xl font-headline text-on-background mb-6"
            >
              {{ service.title }}
            </h3>
            ...
            <ul class="space-y-3 mb-12 flex-grow">
              ...
              >
                <span
                  class="material-symbols-outlined text-primary text-lg shrink-0 mt-0.5"
                  >check_circle</span
                >
                {{ item }}
              </li>
            ...
            <a
              class="inline-flex items-center gap-4 text-primary font-label text-sm tracking-widest uppercase group-hover:gap-6 transition-all mt-auto"
              href="https://wa.me/2347085360145"
              target="_blank"
              rel="noopener noreferrer"
            >
    ...
    <section
      class="relative w-full h-[60vh] md:h-[80vh] overflow-hidden bg-[#131313]"
    >
      <video
        ...
        muted
        playsinline
        src="https://res.cloudinary.com/dn786s1zr/video/upload/v1776100618/LOOP_wj3mns.mp4"
      ></video>
      <!-- Overlay -->
    ...
    <section
      id="portfolio"
      class="py-12 md:py-32 bg-surface-container-lowest overflow-hidden"
    >
      <div class="max-w-screen-2xl mx-auto px-6 md:px-0">
        <div class="text-center mb-12 md:mb-24">
          <span
            ...
            >The Curation</span
          >
          <h2 class="text-3xl lg:text-4xl font-headline italic">
            Recent Works
          </h2>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
          ...
          >
            ...
            >
              <span
                class="text-white font-label tracking-widest uppercase text-sm border border-white/50 px-6 py-2 backdrop-blur-sm shadow-xl"
                >View Work</span
              >
            </div>
          </div>
    ...
    <section id="about" class="py-12 md:py-32 px-6 md:px-12 bg-background">
      <div
        class="max-w-screen-xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-24 items-center"
      >
        <div class="relative">
          ...
          <div
            class="absolute -bottom-8 -right-8 w-48 h-48 bg-primary/10 backdrop-blur-3xl -z-10"
          ></div>
        </div>
        <div>
          <span
            class="font-label text-xs tracking-[0.3em] text-primary uppercase mb-6 block"
            >About Me.</span
          >
          <h2 class="text-5xl font-headline mb-2 leading-tight">
            Oluwadamilola Badmus
          </h2>
          <p>Founder, Kanlilly Beauty Studio</p>

          <br />

          <div
            class="space-y-6 text-on-surface-variant font-body text-lg leading-relaxed"
          >
            <p>
              With over a decade in the beauty industry, I bring expertise and
              creativity as a freelance makeup artist and hairstylist. I’ve had
              the privilege of beautifying brides and bridal parties, perfecting
              makeup for headshots, crafting timeless looks for special
              occasions, film, and editorial work, and teaching makeup lessons.
            </p>

            <p>
              Passionate about skincare and the health of the skin, I combine
              the best makeup techniques with proven skincare practices,
              empowering my clients with knowledge to achieve their personal
              beauty goals. Every look I create is personalized, professional,
              and designed to enhance confidence, ensuring every client feels
    ...
    <section id="contact" class="py-20 md:py-40 px-6">
      ...
      >
        ...
        <div class="relative z-10">
          <h2 class="text-5xl md:text-7xl font-headline italic mb-12">
            Reserve Your <br />Experience
          </h2>
          <p
            class="text-on-surface-variant text-xl font-body max-w-xl mx-auto mb-16 font-light"
          >
    ...
    <footer class="bg-[#131313] w-full border-t border-[#ebbb4d]/10">
      ...
      >
        ...
        <div class="flex flex-wrap justify-center gap-8 mb-6 md:mb-0">
          <a
            class="font-manrope text-sm tracking-loose text-white/50 hover:text-[#ebbb4d] transition-colors"
            href="#"
            >Instagram</a
          >
          <a
        ...
        <div
          class="font-manrope text-xs tracking-widest text-white/30 uppercase"
        >
    ...
    >
      ...
      >
        ...
        <div
          class="px-16 md:px-32 relative h-full w-full flex items-center justify-center p-8"
          @click.stop
        >
          <img
